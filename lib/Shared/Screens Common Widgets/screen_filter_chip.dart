...
/// Generic animated filter chip used across all Seller screens.
/// Replaces: InvFilterChip, MpFilterChip, PayFilterChip,
///           ReviewFilterChip, CustomerFilterChip.
class ScreenFilterChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color bg =
        isActive ? (activeColor ?? CColors.backGroundEmeraldGreen) : CColors.backGroundWhite;
