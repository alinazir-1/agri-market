...
class PaymentsCon extends GetxController {
  ...
  final RxnString remindingPaymentId = RxnString();
  ...
  final RxList<PaymentModel> payments = <PaymentModel>[
    PaymentModel(
      ...
      avatarHex: "0xFF7C3AED", // Converted from Color format to Hex String
  ...
  Future<void> sendReminder(PaymentModel payment) async {
    if (remindingPaymentId.value != null) return;
    remindingPaymentId.value = payment.id;
    await Future<void>.delayed(const Duration(milliseconds: 200));
    remindingPaymentId.value = null;
    Get.snackbar(
      'Reminder Sent',
      'Payment reminder sent to ${payment.buyerName}',
      backgroundColor: AppColors.badgeSuccessBg,
      colorText: AppColors.textEmeraldGreen,
